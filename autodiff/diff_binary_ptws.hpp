...
namespace AutoDiff
{
    ...
    protected:
        ...
        BinaryPointwiseOperation(Unit<T> &left, Unit<T> &right) : mLeft(left), mRight(right), Unit<T>(left.getDiffTape(), wildcardBroadcastShape(left.refWildcardShape(), right.refWildcardShape()))
        {
